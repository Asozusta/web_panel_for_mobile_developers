(function($) {
  ...
  Selectpicker.DEFAULTS = {
    ...
    noneResultsText: 'داده ای پیدا نشد {0}',
    ...
    createLi: function() {
      ...
      this.$element.find('option').each(function(index) {
        ...
        if ($this.data('thumbnail')) {
          ...
          text =
            '<span class="media">' +
              '<span class="media-left"><img width="20" height="20" style="display:inline; margin-left:10px;" src="' + $this.data('thumbnail') + '" class="media-object" onerror="src=\'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\'"></span>' +
