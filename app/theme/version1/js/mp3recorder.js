(function(window){
  ...
  var RECORDER_WORKER_PATH  = '../app/theme/version1/js/recorderWorker.js';
  var ENCODER_WORKER_PATH   = '../app/theme/version1/js/mp3Worker.js';
  ...
  var MP3Recorder = function(context, stream, cfg) {
    ...
    this.start = function() {
      recording = true;
       this.logStatus('در حال ضبط صدا ...');
    }
    this.stop = function() {
      recording = false;
       this.logStatus('در حال متوقف کردن ضبط صدا ...');
    }
    ...
    this.exportMP3 = function(cb) {
      this.logStatus('در حال تبدیل فرمت ...');
