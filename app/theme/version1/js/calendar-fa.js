...
Calendar._TT["ABOUT"] =
"JalaliJSCalendar\n\n\nTeroject.com | Teroject.ir | we don't remove Copyrights .\n\n\n" +
...
Calendar._TT["PREV_YEAR"] = "سال قبل (برای نمایش نگه دارید)";
Calendar._TT["PREV_MONTH"] = "ماه قبل (برای نمایش نگه دارید)";
Calendar._TT["GO_TODAY"] = "رفتن به امروز";
Calendar._TT["NEXT_MONTH"] = "ماه بعد (برای نمایش نگه دارید)";
Calendar._TT["NEXT_YEAR"] = "سال بعد (برای نمایش نگه دارید)";
...
Calendar._TT["TIME_PART"] = "شیفت کلیک کنید یا بکشید";
