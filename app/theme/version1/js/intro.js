  ...
  */
  ...
  function _showElement(targetElement) {
    ...
    if (oldHelperLayer != null) {
      ...
      // farid skipTooltipButton.className = 'introjs-button introjs-skipbutton';
      // farid _setAnchorAsButton(skipTooltipButton);
      // farid skipTooltipButton.innerHTML = this._options.skipLabel;
